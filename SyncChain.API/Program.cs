...
using (var scope = app.Services.CreateScope())
{
    ...
    db.Database.ExecuteSqlRaw("""
        ...
        CREATE TABLE IF NOT EXISTS "DiaChi" (
            "MaDiaChi" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            "MaNguoiDung" integer NOT NULL,
            "TenNguoiNhan" text NOT NULL DEFAULT '',
            "SoDienThoai" text NOT NULL DEFAULT '',
            "TinhThanh" text NOT NULL DEFAULT '',
            "QuanHuyen" text NOT NULL DEFAULT '',
            "PhuongXa" text NOT NULL DEFAULT '',
            "DiaChiChiTiet" text NOT NULL DEFAULT '',
            "LaMacDinh" boolean NOT NULL DEFAULT FALSE,
            "NgayTao" timestamp with time zone NOT NULL DEFAULT now()
        );
        CREATE INDEX IF NOT EXISTS "IX_DiaChi_MaNguoiDung" ON "DiaChi" ("MaNguoiDung");

        CREATE TABLE IF NOT EXISTS "ThongBao" (
            "MaThongBao" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            "MaNguoiDung" integer NOT NULL,
            "LoaiThongBao" text NOT NULL DEFAULT '',
            "TieuDe" text NOT NULL DEFAULT '',
            "NoiDung" text NOT NULL DEFAULT '',
            "DaDoc" boolean NOT NULL DEFAULT FALSE,
            "NgayTao" timestamp with time zone NOT NULL DEFAULT now(),
            "MaDonHang" integer NULL
        );
        CREATE INDEX IF NOT EXISTS "IX_ThongBao_MaNguoiDung" ON "ThongBao" ("MaNguoiDung", "DaDoc");
        ...
        CREATE INDEX IF NOT EXISTS "IX_GioHang_MaNguoiDung" ON "GioHang" ("MaNguoiDung");

        CREATE TABLE IF NOT EXISTS "ChiTietGioHang" (
            "MaChiTietGio" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            "MaGioHang" integer NOT NULL REFERENCES "GioHang" ("MaGioHang") ON DELETE CASCADE,
        ...
        ALTER TABLE "DonHang" ADD COLUMN IF NOT EXISTS "PhuongThucThanhToan" character varying(30) NOT NULL DEFAULT 'cod';

        CREATE TABLE IF NOT EXISTS "ThanhToan" (
            "MaThanhToan" integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
            "MaDonHang" integer NOT NULL,
            "PhuongThuc" text NOT NULL DEFAULT '',
            "TrangThaiThanhToan" text NOT NULL DEFAULT 'Pending',
            "SoTien" numeric NOT NULL DEFAULT 0,
            "NgayTao" timestamp with time zone NOT NULL DEFAULT now(),
            "NgayCapNhat" timestamp with time zone NULL,
            "MaGiaoDich" text NULL,
            "DuLieuCallback" text NULL
        );
        CREATE INDEX IF NOT EXISTS "IX_ThanhToan_MaDonHang" ON "ThanhToan" ("MaDonHang");
        """);
